...
if (!isSupabaseConfigured) {
  console.warn(
    "[Supabase] Environment variables are missing. Set VITE_SUPABASE_URL and " +
      ...
      "Authentication is disabled until Supabase is configured.",
  );
}

function createSupabaseClient() {
  const supabaseUrl = environment.supabaseUrl || PLACEHOLDER_SUPABASE_URL;
  const supabaseKey = environment.supabaseKey || PLACEHOLDER_SUPABASE_KEY;
