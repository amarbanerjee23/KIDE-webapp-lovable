...
const title = "KIDE Workbench — Explainable Systems Engineering";
    ...
    <main className="flex min-h-screen flex-col bg-background text-foreground">
      <header className="flex h-14 shrink-0 items-center border-b border-border bg-card px-3">
        ...
        <div className="ml-auto flex items-center gap-1">
          <Button asChild variant="ghost" size="sm" className="gap-1.5 text-xs"><Link to="/projects">Projects</Link></Button>
